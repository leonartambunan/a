...
public class UserTypeForm extends BeanEditor {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(com.pinpos.POSConstants.TYPE_NAME + ":");

        jLabel2.setText(com.pinpos.POSConstants.PERMISSIONS + ":");
	...
	protected boolean updateModel() throws IllegalModelStateException {
		...
		if(StringUtils.isEmpty(name)) {
			throw new IllegalModelStateException(com.pinpos.POSConstants.TYPE_NAME_CANNOT_BE_EMPTY);
		}
		
		userType.setName(name);
		userType.clearPermissions();
		
		Object[] checkedValues = listPermissions.getCheckedValues();
