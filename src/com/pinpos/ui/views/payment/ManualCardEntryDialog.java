...
public class ManualCardEntryDialog extends POSDialog implements CardInputter {
	...
	private void createUI() {
		...
		JLabel lblCardNumber = new JLabel(Messages.getString("Card.Number"));
		...
		JLabel lblExpieryMonth = new JLabel("Expiry Month");
		...
		JLabel lblExpieryYear = new JLabel("Expiry Year");
