...
public class NumberSelectionView extends TransparentPanel implements ActionListener {
	...
	private void initComponents() {
		...
		btnClearAll.setText(com.pinpos.POSConstants.CLEAR_ALL);
		btnClearAll.setActionCommand(com.pinpos.POSConstants.CLEAR_ALL);
		...
		String[][] numbers = {
        		...
        		{"4","5","6"},
        		{"1","2","3"},
        		{".","0",com.pinpos.POSConstants.CLEAR}
        };
        ...
        for (int i = 0; i < numbers.length; i++) {
			for (int j = 0; j < numbers[i].length; j++) {
				...
				if (icon == null) {
					...
					if (com.pinpos.POSConstants.CLEAR.equals(buttonText)) {
						posButton.setText(buttonText);
					}
				}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(actionCommand.equals(com.pinpos.POSConstants.CLEAR_ALL)) {
			tfNumber.setText("0");
		}
		else if(actionCommand.equals(com.pinpos.POSConstants.CLEAR)) {
