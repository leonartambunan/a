...
import com.pinpos.swing.POSToggleButton;
...
public class NoteView extends JPanel implements ActionListener, ChangeListener {
	...
	public NoteView() {
		...
		POSToggleButton toggleButton = new POSToggleButton("CAPS");
		toggleButton.setText("CAPS");
		toggleButton.addChangeListener(this);
		eastPanel.add(toggleButton);

		button = new PosButton();
		button.setText(com.pinpos.POSConstants.CLEAR);
		button.addActionListener(this);
		eastPanel.add(button);

		button = new PosButton();
		button.setText(com.pinpos.POSConstants.CLEAR_ALL);
		button.addActionListener(this);
		eastPanel.add(button);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (s.equals(com.pinpos.POSConstants.OK)) {
			//canceled = false;
			//dispose();
		}
		else if (s.equals(com.pinpos.POSConstants.CANCEL)) {
			//canceled = true;
			//dispose();
		}
		else if (s.equals(com.pinpos.POSConstants.CLEAR)) {
		...
		else if (s.equals(com.pinpos.POSConstants.CLEAR_ALL)) {
			note.setText("");
		}
