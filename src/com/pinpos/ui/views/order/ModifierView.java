...
//	private final static ImageIcon extraIcon = IconFactory.getIcon("extraModifier16.png");
	...
	public ModifierView() {
		super(com.pinpos.POSConstants.MODIFIERS);
	}
...
//		}
	...
	public void doGoBack() {
		...
		if (!requiredModifierAdded) {
			int option = JOptionPane.showConfirmDialog(this, com.pinpos.POSConstants.REQUIRED_MODIFIERS_NOT_ADDED, com.pinpos.POSConstants.CONFIRM, JOptionPane.YES_NO_OPTION);
	...
	private class ModifierButton extends PosButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(ticketItemModifier.getModifierType() != null) {
				modifierType = ticketItemModifier.getModifierType();
			}
			switch (modifierType) {
