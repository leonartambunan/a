 ...
 * @author  MShahriar
 */
public class OrderView extends com.pinpos.swing.TransparentPanel {
	...
	public void init() {
		...
		addView("VIEW_EMPTY", new com.pinpos.swing.TransparentPanel());
    ...
    private void initComponents() {
        categoryView = new com.pinpos.ui.views.order.CategoryView();
        ...
        midContainer = new com.pinpos.swing.TransparentPanel();
        othersView = new com.pinpos.ui.views.order.OthersView();
    ...
    private com.pinpos.ui.views.order.CategoryView categoryView;
    private com.pinpos.swing.TransparentPanel jPanel1;
    private com.pinpos.swing.TransparentPanel midContainer;
    private com.pinpos.ui.views.order.OthersView othersView;
	...
	public com.pinpos.ui.views.order.CategoryView getCategoryView() {
		return categoryView;
	}

	public void setCategoryView(com.pinpos.ui.views.order.CategoryView categoryView) {
	...
	public com.pinpos.ui.views.order.TicketView getTicketView() {
		return ticketView;
	}

	public void setTicketView(com.pinpos.ui.views.order.TicketView ticketView) {
	...
	public com.pinpos.ui.views.order.OthersView getOthersView() {
		return othersView;
	}
	...
	public void setVisible(boolean aFlag) {
		if(aFlag) {
			try {
				...
				POSMessageDialog.showError(com.pinpos.POSConstants.ERROR_MESSAGE, t);
			}
		}
		else {
