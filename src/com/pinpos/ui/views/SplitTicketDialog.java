...
import com.pinpos.ui.views.order.TicketForSplitView;
...
public class SplitTicketDialog extends POSDialog {
    ...
    private void initComponents() {
        ...
        transparentPanel5 = new com.pinpos.swing.TransparentPanel();
        pOSTitleLabel1 = new com.pinpos.swing.POSTitleLabel();
        btnNumSplit2 = new com.pinpos.swing.POSToggleButton("2");
        btnNumSplit3 = new com.pinpos.swing.POSToggleButton("3");
        btnNumSplit4 = new com.pinpos.swing.POSToggleButton("4");
        lblTicketId = new com.pinpos.swing.POSTitleLabel();
        transparentPanel4 = new com.pinpos.swing.TransparentPanel();
        ticket1Container = new org.jdesktop.swingx.JXImagePanel();
        mainTicketView = new com.pinpos.ui.views.order.TicketForSplitView();
        ticket2Container = new org.jdesktop.swingx.JXImagePanel();
        ticketView2 = new com.pinpos.ui.views.order.TicketForSplitView();
        ticket3Container = new org.jdesktop.swingx.JXImagePanel();
        ticketView3 = new com.pinpos.ui.views.order.TicketForSplitView();
        ticket4Container = new org.jdesktop.swingx.JXImagePanel();
        ticketView4 = new com.pinpos.ui.views.order.TicketForSplitView();

        titlePanel1.setTitle(com.pinpos.POSConstants.SPLIT_TICKET);
        ...
        pOSTitleLabel1.setText(com.pinpos.POSConstants.NUMBER_OF_SPLITS);
	...
	private void btnFinishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinishActionPerformed
		...
		try {
			...
			//save the action
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.SPLIT_CHECK, com.pinpos.POSConstants.RECEIPT_REPORT_TICKET_NO_LABEL + ":"+mainTicketView.getTicket().getId());
    ...
    private com.pinpos.swing.POSToggleButton btnNumSplit2;
    private com.pinpos.swing.POSToggleButton btnNumSplit3;
    private com.pinpos.swing.POSToggleButton btnNumSplit4;
    private javax.swing.ButtonGroup buttonGroup1;
    private com.pinpos.swing.POSTitleLabel lblTicketId;
    private com.pinpos.ui.views.order.TicketForSplitView mainTicketView;
    private com.pinpos.swing.POSTitleLabel pOSTitleLabel1;
    ...
    private com.pinpos.ui.views.order.TicketForSplitView ticketView2;
    private com.pinpos.ui.views.order.TicketForSplitView ticketView3;
    private com.pinpos.ui.views.order.TicketForSplitView ticketView4;
    ...
    private com.pinpos.swing.TransparentPanel transparentPanel4;
    private com.pinpos.swing.TransparentPanel transparentPanel5;
	...
	public void setTicket(Ticket ticket) {
		this.ticket = ticket;
		if (ticket != null)
			lblTicketId.setText(com.pinpos.POSConstants.ORIGINAL_TICKET_ID + ": " + ticket.getId());
