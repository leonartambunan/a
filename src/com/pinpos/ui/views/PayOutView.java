...
import com.pinpos.model.dao.PayoutReasonDAO;
import com.pinpos.model.dao.PayoutRecepientDAO;
import com.pinpos.swing.TransparentPanel;
import com.pinpos.ui.dialog.NotesDialog;
...
public class PayOutView extends TransparentPanel {
    ...
    private void initComponents() {
        numberSelectionView = new com.pinpos.ui.views.NumberSelectionView();
        jLabel1 = new javax.swing.JLabel();
        cbReason = new javax.swing.JComboBox();
        jLabel2 = new javax.swing.JLabel();
        cbRecepient = new javax.swing.JComboBox();
        jLabel3 = new javax.swing.JLabel();
        btnAddNote = new com.pinpos.swing.PosButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        tfNote = new javax.swing.JTextArea();

        numberSelectionView.setTitle(com.pinpos.POSConstants.AMOUNT_PAID_OUT);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel1.setText(com.pinpos.POSConstants.PAY_OUT_REASON);

        cbReason.setFont(new java.awt.Font("Tahoma", 1, 18));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel2.setText(com.pinpos.POSConstants.SELECT_PAY_OUT_RECEPIENT);

        cbRecepient.setFont(new java.awt.Font("Tahoma", 1, 18));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel3.setText(com.pinpos.POSConstants.NOTES);
    ...
    private void btnAddNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNoteActionPerformed
    	...
    	dialog.setTitle(com.pinpos.POSConstants.ENTER_PAYOUT_NOTE);
    	dialog.pack();
    	dialog.open();
    ...
    private com.pinpos.swing.PosButton btnAddNote;
    ...
    private com.pinpos.ui.views.NumberSelectionView numberSelectionView;
