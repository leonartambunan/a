...
import com.pinpos.report.PayrollReportModel;
...
public class PayrollReportView extends TransparentPanel {
    ...
    public PayrollReportView() {
        //cbUserType.setModel(new DefaultComboBoxModel(new String[]{com.pinpos.POSConstants.ALL, com.pinpos.POSConstants.SERVER, com.pinpos.POSConstants.CASHIER, com.pinpos.POSConstants.MANAGER}));
    ...
    private void viewReport() {
        ...
        try {
            JasperReport report = (JasperReport) JRLoader.loadObject(getClass().getResource("/com/pinpos/ui/report/PayrollReport.jasper"));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.add(panel1, new GridConstraints(0, 0, 1, 1, ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, 1, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText(com.pinpos.POSConstants.FROM + ":");
        panel1.add(label1, new GridConstraints(0, 0, 1, 1, ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText(com.pinpos.POSConstants.TO + ":");
        panel1.add(label2, new GridConstraints(1, 0, 1, 1, ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        //final JLabel label3 = new JLabel();
        //label3.setText(com.pinpos.POSConstants.TERMINAL);
        ...
        panel1.add(fromDatePicker, new GridConstraints(0, 1, 1, 1, ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(147, 24), null, 0, false));
        toDatePicker = UiUtil.getCurrentMonthEnd();
        panel1.add(toDatePicker, new GridConstraints(1, 1, 1, 1, ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(147, 24), null, 0, false));
        final Spacer spacer1 = new Spacer();
        panel1.add(spacer1, new GridConstraints(0, 2, 1, 1, ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        //label4.setText(com.pinpos.POSConstants.USER_TYPE_);
        ...
        panel1.add(separator1, new GridConstraints(5, 0, 1, 3, ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        reportPanel = new JPanel();
        reportPanel.setLayout(new BorderLayout(0, 0));
        contentPane.add(reportPanel, new GridConstraints(1, 0, 1, 1, ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    }
