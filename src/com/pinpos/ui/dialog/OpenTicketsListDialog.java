...
public class OpenTicketsListDialog extends POSDialog {
	...
	public OpenTicketsListDialog(java.awt.Frame parent, boolean modal) {
		...
		initComponents();
		setTitle(com.pinpos.POSConstants.ACTIVE_TICKETS);
		titlePanel.setTitle(com.pinpos.POSConstants.ACTIVE_TICKETS_BEFORE_DRAWER_RESET);
	...
	private void initComponents() {
		titlePanel = new com.pinpos.ui.TitlePanel();
		...
		//        btnPrint = new com.pinpos.swing.PosButton();
		btnTransferServer = new com.pinpos.swing.PosButton();
		...
		//        btnPrint.setText(com.pinpos.POSConstants.PRINT);
		...
		btnClose.setText(com.pinpos.POSConstants.CLOSE);
	...
	private Ticket getSelectedTicket() {
		...
		if (row < 0) {
			POSMessageDialog.showError(com.pinpos.POSConstants.SELECT_TICKET);
			return null;
		}
	...
	private void doTransferServer(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doTransferServer
		try {
			...
			POSMessageDialog.showError(com.pinpos.POSConstants.ERROR_MESSAGE);
		}
...
//	}
	...
	class OpenTicketListTableModel extends AbstractTableModel {
		...
		public String getColumnName(int column) {
			switch (column) {
				case 0:
					return com.pinpos.POSConstants.TICKET_ID;

				case 1:
					return com.pinpos.POSConstants.SERVER;
...
//		DecimalFormat decimalFormat = new DecimalFormat("0.00");
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
			...
			if (value instanceof Date) {
				...
				label.setText(currencySymbol + NumberUtil.formatToCurrency((Double) value));
