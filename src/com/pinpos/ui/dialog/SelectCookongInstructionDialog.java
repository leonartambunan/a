...
public class SelectCookongInstructionDialog extends POSDialog implements ActionListener {
	...
	protected void initUI() {
		...
		btnNew = new PosButton(com.pinpos.POSConstants.NEW);
		btnOk = new PosButton(com.pinpos.POSConstants.OK);
		btnCancel = new PosButton(com.pinpos.POSConstants.CANCEL);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(com.pinpos.POSConstants.OK.equalsIgnoreCase(actionCommand)) {
			doOk();
		}
		else if(com.pinpos.POSConstants.CANCEL.equalsIgnoreCase(actionCommand)) {
			doCancel();
		}
		else if(com.pinpos.POSConstants.NEW.equalsIgnoreCase(actionCommand)) {
			doCreateNew();
		}
	}
