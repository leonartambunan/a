...
public class ManagerDialog extends JFrame {
    ...
    private void initComponents() {
        ...
        btnShowTips = new com.pinpos.swing.PosButton();
        btnDrawerPullReport = new com.pinpos.swing.PosButton();
        btnOpenTickets = new com.pinpos.swing.PosButton();
        btnCashDrops = new com.pinpos.swing.PosButton();
        transparentPanel1 = new com.pinpos.swing.TransparentPanel();
        btnFinish = new com.pinpos.swing.PosButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        titlePanel1.setTitle(com.pinpos.POSConstants.MANAGER_FUNCTION);
        ...
        btnShowTips.setText(com.pinpos.POSConstants.SERVER_TIPS);
        ...
        btnDrawerPullReport.setText(com.pinpos.POSConstants.DRAWER_PULL);
        ...
        btnOpenTickets.setText(com.pinpos.POSConstants.OPEN_TICKETS);
        ...
        btnCashDrops.setText(com.pinpos.POSConstants.DRAWER_BLEED);
    	...
    	Job job = new Job() {
			...
			public Object run() {
				try {
					...
					POSMessageDialog.showError(com.pinpos.POSConstants.ERROR_MESSAGE, e);
				} finally {
		...
		Job job = new Job() {
			...
			public Object run() {
				try {
					...
					dialog.setTitle(com.pinpos.POSConstants.DRAWER_PULL);
					dialog.initialize();
    	...
    	Job job = new Job() {
			...
			public Object run() {
				try {
					...
					panel.add(new JLabel(com.pinpos.POSConstants.SELECT_USER + ":"), "grow");
					JComboBox userCombo = new JComboBox(new ListComboBoxModel(users));
					panel.add(userCombo, "grow, wrap");
					panel.add(new JLabel(com.pinpos.POSConstants.FROM + ":"), "grow");
					panel.add(fromDatePicker,"wrap");
					panel.add(new JLabel(com.pinpos.POSConstants.TO_), "grow");
					panel.add(toDatePicker);
					
					int option = JOptionPane.showOptionDialog(ManagerDialog.this, panel, com.pinpos.POSConstants.SELECT_CRIETERIA, JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
    ...
    private com.pinpos.swing.PosButton btnDrawerPullReport;
    private com.pinpos.swing.PosButton btnCashDrops;
    private com.pinpos.swing.PosButton btnFinish;
    private com.pinpos.swing.PosButton btnOpenTickets;
    private com.pinpos.swing.PosButton btnShowTips;
