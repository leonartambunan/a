...
import com.pinpos.model.dao.VoidReasonDAO;
...
public class VoidTicketDialog extends POSDialog {
    ...
    public VoidTicketDialog(java.awt.Frame parent, boolean modal) {
        ...
        try {
			...
			POSMessageDialog.showError(com.pinpos.POSConstants.CANNOT_LOAD_VOID_REASONS, e);
		}
    ...
    private void initComponents() {
        ...
        contentPane = new com.pinpos.swing.TransparentPanel();
        titlePanel1 = new com.pinpos.ui.TitlePanel();
        transparentPanel1 = new com.pinpos.swing.TransparentPanel();
        jPanel1 = new javax.swing.JPanel();
        ticketView = new com.pinpos.ui.views.order.TicketView();
        jPanel2 = new javax.swing.JPanel();
        ticketDetailView = new com.pinpos.ui.views.TicketDetailView();
        transparentPanel2 = new com.pinpos.swing.TransparentPanel();
        cbVoidReasons = new javax.swing.JComboBox();
        btnNewVoidReason = new com.pinpos.swing.PosButton();
        ...
        btnVoid = new com.pinpos.swing.PosButton();
        ...
        titlePanel1.setTitle(com.pinpos.POSConstants.VOID_TICKET);
        ...
        chkItemsWasted.setText(com.pinpos.POSConstants.ITEMS_WASTED);
        ...
        jLabel1.setText(com.pinpos.POSConstants.VOID_REASON + ":");
    ...
    private void btnNewVoidReasonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewVoidReasonActionPerformed
    	try {
			...
			dialog.setTitle(com.pinpos.POSConstants.ENTER_VOID_REASON);
			dialog.pack();
			dialog.open();
    ...
    private void btnVoidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoidActionPerformed
    	try {
			...
			//save the action
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.VOID_CHECK, com.pinpos.POSConstants.RECEIPT_REPORT_TICKET_NO_LABEL + ":"+ticket.getId() +"; Total" + ": " + NumberUtil.formatToCurrency(ticket.getTotalAmount()));
    ...
    private com.pinpos.swing.PosButton btnNewVoidReason;
    private com.pinpos.swing.PosButton btnVoid;
    private javax.swing.JComboBox cbVoidReasons;
    private javax.swing.JCheckBox chkItemsWasted;
    private com.pinpos.swing.TransparentPanel contentPane;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JSeparator jSeparator1;
    private com.pinpos.ui.views.TicketDetailView ticketDetailView;
    private com.pinpos.ui.views.order.TicketView ticketView;
