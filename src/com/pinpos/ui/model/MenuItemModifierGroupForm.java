...
public class MenuItemModifierGroupForm extends BeanEditor {
    ...
    public MenuItemModifierGroupForm(MenuItemModifierGroup modifierGroup) {
    	...
    	try {
			...
			throw new PosRuntimeException(com.pinpos.POSConstants.ERROR_MESSAGE);
		}
    ...
    private void initComponents() {
        ...
        jLabel1.setText(com.pinpos.POSConstants.MODIFIER_GROUP + ":");

        jLabel2.setText(com.pinpos.POSConstants.MIN_QUANTITY + ":");

        jLabel3.setText(com.pinpos.POSConstants.MAX_QUANTITY + ":");
	...
	protected boolean updateModel() {
		...
		if(group == null) {
			POSMessageDialog.showError(this, com.pinpos.POSConstants.MODIFIER_GROUP_REQUIRED);
			return false;
		}
		MenuItemModifierGroup modifierGroup = (MenuItemModifierGroup) getBean();
	...
	public String getDisplayText() {
		MenuItemModifierGroup modifierGroup = (MenuItemModifierGroup) getBean();
		if(modifierGroup.getId() == null) {
			return com.pinpos.POSConstants.ADD_NEW_MODIFIER_GROUP_IN_MENU_ITEM_;
		}
		
		return com.pinpos.POSConstants.EDIT_MODIFIER_GROUP_IN_MENU_ITEM_;
	}
