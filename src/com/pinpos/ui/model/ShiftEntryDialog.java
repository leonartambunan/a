...
public class ShiftEntryDialog extends POSDialog {
    ...
    public ShiftEntryDialog(Shift shift) {
        ...
        setTitle(com.pinpos.POSConstants.NEW_SHIFT);
...
// call onCancel() on ESCAPE
    ...
    private boolean calculateShifts() {
        ...
        if (!shiftEnd.after(shiftStart)) {
            POSMessageDialog.showError(this, com.pinpos.POSConstants.SHIFT_END_TIME_MUST_BE_GREATER_THAN_SHIFT_START_TIME);
            return false;
        }
        return true;
    }
    ...
    private void onOK() {
        try {
            ...
            if (shift.getId() == null && dao.exists(shift.getName())) {
                POSMessageDialog.showError(this, com.pinpos.POSConstants.SHIFT_NAME_ALREADY_EXISTS);
                return;
            }
            ...
            POSMessageDialog.showError(this, com.pinpos.POSConstants.ERROR_SAVING_SHIFT_STATE, e);
        }
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText(com.pinpos.POSConstants.START_TIME + ":");
        ...
        label2.setText(com.pinpos.POSConstants.HOUR + ":");
        ...
        label3.setText(com.pinpos.POSConstants.MIN + ":");
        ...
        defaultComboBoxModel1.addElement(com.pinpos.POSConstants.AM);
        defaultComboBoxModel1.addElement(com.pinpos.POSConstants.PM);
        ...
        label4.setText(com.pinpos.POSConstants.END_TIME + ":");
        ...
        label5.setText(com.pinpos.POSConstants.HOUR + ":");
        ...
        label6.setText(com.pinpos.POSConstants.MIN + ":");
        ...
        defaultComboBoxModel2.addElement(com.pinpos.POSConstants.AM);
        defaultComboBoxModel2.addElement(com.pinpos.POSConstants.PM);
        ...
        label7.setText(com.pinpos.POSConstants.SHIFT_NAME + ":");
