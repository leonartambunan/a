...
public class MenuModifierForm extends BeanEditor {
    ...
    private void initComponents() {
        ...
        jLabel5.setText(com.pinpos.POSConstants.TAX_RATE + ":");
        ...
        jLabel4.setText(com.pinpos.POSConstants.GROUP + ":");

        btnPrintToKitchen.setText(com.pinpos.POSConstants.PRINT_TO_KITCHEN);
        ...
        jTabbedPane1.addTab(com.pinpos.POSConstants.GENERAL, jPanel1);
	...
	public boolean save() {
		try {
			...
			MessageDialog.showError(com.pinpos.POSConstants.SAVE_ERROR, e);
			return false;
		}
		return true;
	}
	...
	protected boolean updateModel() {
		...
		modifier.setPrice((Double) tfPrice.getValue());
		modifier.setExtraPrice((Double) tfExtraPrice.getValue());
		modifier.setTax((Tax) cbTaxes.getSelectedItem());
		modifier.setModifierGroup((MenuModifierGroup) cbModifierGroup.getSelectedItem());
		modifier.setShouldPrintToKitchen(btnPrintToKitchen.isSelected());
