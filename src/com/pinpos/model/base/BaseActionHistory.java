...
public abstract class BaseActionHistory  implements Comparable, Serializable {
	...
	// many to one
	private com.pinpos.model.User performer;
	 ...
	 */
	public com.pinpos.model.User getPerformer () {
			return performer;
	}
	 ...
	 */
	public void setPerformer (com.pinpos.model.User performer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.ActionHistory)) return false;
		else {
			com.pinpos.model.ActionHistory actionHistory = (com.pinpos.model.ActionHistory) obj;
