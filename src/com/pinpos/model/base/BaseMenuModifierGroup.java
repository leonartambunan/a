...
public abstract class BaseMenuModifierGroup  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<com.pinpos.model.MenuModifier> modifiers;
	 ...
	 */
	public java.util.Set<com.pinpos.model.MenuModifier> getModifiers () {
			return modifiers;
	}
	 ...
	 */
	public void setModifiers (java.util.Set<com.pinpos.model.MenuModifier> modifiers) {
		this.modifiers = modifiers;
	}

	public void addTomodifiers (com.pinpos.model.MenuModifier menuModifier) {
		if (null == getModifiers()) setModifiers(new java.util.TreeSet<com.pinpos.model.MenuModifier>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.MenuModifierGroup)) return false;
		else {
			com.pinpos.model.MenuModifierGroup menuModifierGroup = (com.pinpos.model.MenuModifierGroup) obj;
