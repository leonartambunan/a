...
public abstract class BaseAttendenceHistory  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.AttendenceHistory)) return false;
		else {
			com.pinpos.model.AttendenceHistory attendenceHistory = (com.pinpos.model.AttendenceHistory) obj;
