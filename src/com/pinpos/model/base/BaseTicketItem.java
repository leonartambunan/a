...
import com.pinpos.model.TicketItemCookingInstruction;
...
public abstract class BaseTicketItem  implements Comparable, Serializable {
	...
	public BaseTicketItem (
		...
		com.pinpos.model.Ticket ticket) {
	...
	// many to one
	private com.pinpos.model.Ticket ticket;

	// collections
	private java.util.List<com.pinpos.model.TicketItemModifierGroup> ticketItemModifierGroups;
	 ...
	 */
	public com.pinpos.model.Ticket getTicket () {
			return ticket;
	}
	 ...
	 */
	public void setTicket (com.pinpos.model.Ticket ticket) {
		this.ticket = ticket;
	}
	 ...
	 */
	public java.util.List<com.pinpos.model.TicketItemModifierGroup> getTicketItemModifierGroups () {
	 ...
	 */
	public void setTicketItemModifierGroups (java.util.List<com.pinpos.model.TicketItemModifierGroup> ticketItemModifierGroups) {
		this.ticketItemModifierGroups = ticketItemModifierGroups;
	}

	public void addToticketItemModifierGroups (com.pinpos.model.TicketItemModifierGroup ticketItemModifierGroup) {
		if (null == getTicketItemModifierGroups()) setTicketItemModifierGroups(new java.util.ArrayList<com.pinpos.model.TicketItemModifierGroup>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.TicketItem)) return false;
		else {
			com.pinpos.model.TicketItem ticketItem = (com.pinpos.model.TicketItem) obj;
