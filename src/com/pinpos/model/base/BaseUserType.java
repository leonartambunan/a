...
public abstract class BaseUserType  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<com.pinpos.model.UserPermission> permissions;
	 ...
	 */
	public java.util.Set<com.pinpos.model.UserPermission> getPermissions () {
			return permissions;
	}
	 ...
	 */
	public void setPermissions (java.util.Set<com.pinpos.model.UserPermission> permissions) {
		this.permissions = permissions;
	}

	public void addTopermissions (com.pinpos.model.UserPermission userPermission) {
		if (null == getPermissions()) setPermissions(new java.util.TreeSet<com.pinpos.model.UserPermission>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.UserType)) return false;
		else {
			com.pinpos.model.UserType userType = (com.pinpos.model.UserType) obj;
