...
public abstract class BaseCashDrawerResetHistory  implements Comparable, Serializable {
	...
	// one to one
	private com.pinpos.model.DrawerPullReport drawerPullReport;

	// many to one
	private com.pinpos.model.User resetedBy;
	 ...
	 */
	public com.pinpos.model.DrawerPullReport getDrawerPullReport () {
	 ...
	 */
	public void setDrawerPullReport (com.pinpos.model.DrawerPullReport drawerPullReport) {
	 ...
	 */
	public com.pinpos.model.User getResetedBy () {
			return resetedBy;
	}
	 ...
	 */
	public void setResetedBy (com.pinpos.model.User resetedBy) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.CashDrawerResetHistory)) return false;
		else {
			com.pinpos.model.CashDrawerResetHistory cashDrawerResetHistory = (com.pinpos.model.CashDrawerResetHistory) obj;
