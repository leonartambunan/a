...
public abstract class BaseMenuGroup  implements Comparable, Serializable {
	...
	// many to one
	private com.pinpos.model.MenuCategory parent;
	 ...
	 */
	public com.pinpos.model.MenuCategory getParent () {
			return parent;
	}
	 ...
	 */
	public void setParent (com.pinpos.model.MenuCategory parent) {
		this.parent = parent;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.MenuGroup)) return false;
		else {
			com.pinpos.model.MenuGroup menuGroup = (com.pinpos.model.MenuGroup) obj;
