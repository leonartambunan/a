...
public abstract class BaseMenuItem  implements Comparable, Serializable {
	...
	// many to one
	private com.pinpos.model.MenuGroup parent;
	private com.pinpos.model.Tax tax;
	private com.pinpos.model.inventory.Recepie recepie;

	// collections
	private java.util.List<com.pinpos.model.MenuItemShift> shifts;
	private java.util.List<com.pinpos.model.MenuItemModifierGroup> menuItemModiferGroups;
	 ...
	 */
	public com.pinpos.model.MenuGroup getParent () {
					return parent;
			}
	 ...
	 */
	public void setParent (com.pinpos.model.MenuGroup parent) {
		this.parent = parent;
	}
	 ...
	 */
	public com.pinpos.model.Tax getTax () {
					return tax;
			}
	 ...
	 */
	public void setTax (com.pinpos.model.Tax tax) {
		this.tax = tax;
	}
	 ...
	 */
	public com.pinpos.model.inventory.Recepie getRecepie () {
					return recepie;
			}
	 ...
	 */
	public void setRecepie (com.pinpos.model.inventory.Recepie recepie) {
	 ...
	 */
	public java.util.List<com.pinpos.model.MenuItemShift> getShifts () {
					return shifts;
			}
	 ...
	 */
	public void setShifts (java.util.List<com.pinpos.model.MenuItemShift> shifts) {
		this.shifts = shifts;
	}

	public void addToshifts (com.pinpos.model.MenuItemShift menuItemShift) {
		if (null == getShifts()) setShifts(new java.util.ArrayList<com.pinpos.model.MenuItemShift>());
	 ...
	 */
	public java.util.List<com.pinpos.model.MenuItemModifierGroup> getMenuItemModiferGroups () {
	 ...
	 */
	public void setMenuItemModiferGroups (java.util.List<com.pinpos.model.MenuItemModifierGroup> menuItemModiferGroups) {
		this.menuItemModiferGroups = menuItemModiferGroups;
	}

	public void addTomenuItemModiferGroups (com.pinpos.model.MenuItemModifierGroup menuItemModifierGroup) {
		if (null == getMenuItemModiferGroups()) setMenuItemModiferGroups(new java.util.ArrayList<com.pinpos.model.MenuItemModifierGroup>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.MenuItem)) return false;
		else {
			com.pinpos.model.MenuItem menuItem = (com.pinpos.model.MenuItem) obj;
