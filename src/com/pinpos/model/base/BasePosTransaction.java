...
public abstract class BasePosTransaction  implements Comparable, Serializable {
	...
	private com.pinpos.model.User user;
	 ...
	 */
	public com.pinpos.model.User getUser () {
			return user;
	}
	 ...
	 */
	public void setUser (com.pinpos.model.User user) {
		this.user = user;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.PosTransaction)) return false;
		else {
			com.pinpos.model.PosTransaction posTransaction = (com.pinpos.model.PosTransaction) obj;
