...
public abstract class BaseTicketItemModifierGroup  implements Comparable, Serializable {
	...
	// many to one
	private com.pinpos.model.TicketItem parent;

	// collections
	private java.util.List<com.pinpos.model.TicketItemModifier> ticketItemModifiers;
	 ...
	 */
	public com.pinpos.model.TicketItem getParent () {
			return parent;
	}
	 ...
	 */
	public void setParent (com.pinpos.model.TicketItem parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.List<com.pinpos.model.TicketItemModifier> getTicketItemModifiers () {
	 ...
	 */
	public void setTicketItemModifiers (java.util.List<com.pinpos.model.TicketItemModifier> ticketItemModifiers) {
		this.ticketItemModifiers = ticketItemModifiers;
	}

	public void addToticketItemModifiers (com.pinpos.model.TicketItemModifier ticketItemModifier) {
		if (null == getTicketItemModifiers()) setTicketItemModifiers(new java.util.ArrayList<com.pinpos.model.TicketItemModifier>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.TicketItemModifierGroup)) return false;
		else {
			com.pinpos.model.TicketItemModifierGroup ticketItemModifierGroup = (com.pinpos.model.TicketItemModifierGroup) obj;
