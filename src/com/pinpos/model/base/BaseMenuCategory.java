...
public abstract class BaseMenuCategory  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<com.pinpos.model.MenuGroup> menuGroups;
	 ...
	 */
	public java.util.Set<com.pinpos.model.MenuGroup> getMenuGroups () {
			return menuGroups;
	}
	 ...
	 */
	public void setMenuGroups (java.util.Set<com.pinpos.model.MenuGroup> menuGroups) {
		this.menuGroups = menuGroups;
	}

	public void addTomenuGroups (com.pinpos.model.MenuGroup menuGroup) {
		if (null == getMenuGroups()) setMenuGroups(new java.util.TreeSet<com.pinpos.model.MenuGroup>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.MenuCategory)) return false;
		else {
			com.pinpos.model.MenuCategory menuCategory = (com.pinpos.model.MenuCategory) obj;
