...
public abstract class BaseInventoryUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.pinpos.model.inventory.InventoryUnit)) return false;
		else {
			com.pinpos.model.inventory.InventoryUnit inventoryUnit = (com.pinpos.model.inventory.InventoryUnit) obj;
