...
import com.pinpos.model.util.TicketSummary;
...
//	}
	...
	public void voidTicket(Ticket ticket) throws Exception {
		...
		try {
			...
			Criteria criteria = session.createCriteria(com.pinpos.model.PosTransaction.class);
			criteria.add(Restrictions.eq(com.pinpos.model.PosTransaction.PROP_TICKET, ticket));
			List list = criteria.list();
	...
	//	public void saveTransaction(Ticket ticket, com.pinpos.model.PosTransaction transaction, Terminal terminal, User user) throws Exception {
	//		Session session = null;
	//    	Transaction tx = null;
	//    	try {
