...
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					posPrinter.printText(com.pinpos.POSConstants.CHK_NO);
//					posPrinter.printText(String.valueOf(ticket.getId()));
//					posPrinter.endLine();
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					posPrinter.printText(com.pinpos.POSConstants.TBL_);
//					posPrinter.printText(String.valueOf(ticket.getTableNumber()));
//					posPrinter.endLine();
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					posPrinter.printText(com.pinpos.POSConstants.GUEST + " #");
//					posPrinter.printText(String.valueOf(ticket.getNumberOfGuests()));
//					posPrinter.endLine();
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					posPrinter.printText(com.pinpos.POSConstants.SRV_);
//					posPrinter.printText(String.valueOf(ticket.getOwner().getUserId() + "/" + ticket.getOwner()));
//					posPrinter.endLine();
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					posPrinter.printText(com.pinpos.POSConstants.DATE + ": ");
...
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
//					printFirstColumn(posPrinter, com.pinpos.POSConstants.QTY, firstColumnLength);
//					printSecondColumn(posPrinter, com.pinpos.POSConstants.ITEM, firstColumnLength, secondColumnLength, false);
//					printThirdColumn(posPrinter, com.pinpos.POSConstants.UPRICE, thirdColumnLength);
//					printFourthColumn(posPrinter, com.pinpos.POSConstants.SUBTOTAL, fourthColumnLength);
//					posPrinter.endLine();
//
//					posPrinter.beginLine(PosPrinter.SIZE_0);
...
//		Worker.post(job);
	...
	public static void printToKitchen(final Ticket ticket) throws Exception {
		...
		if (PrintConfig.isKitchenPrinterEnabled()) {
...
//		}
	...
	public static void printDrawerPullReport(DrawerPullReport drawerPullReport, Terminal terminal) {
		...
		try {
			...
			JasperReport subReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class.getResourceAsStream("/com/pinpos/report/DrawerPullVoidReport.jasper"));

			parameters.put("subreportParameter", subReport);

			JasperReport mainReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class.getResourceAsStream("/com/pinpos/report/DrawerPullJReport.jasper"));
...
//
//		map.put("checkNo", com.pinpos.POSConstants.CHK_NO + ticket.getId());
//		map.put("tableNo", com.pinpos.POSConstants.TABLE_NO + ticket.getTableNumber());
//		map.put("guestCount", com.pinpos.POSConstants.GUESTS_ + ticket.getNumberOfGuests());
//		map.put("serverName", com.pinpos.POSConstants.SERVER + ": " + ticket.getOwner());
//		map.put("reportDate", com.pinpos.POSConstants.DATE + ": " + Application.formatDate(new Date()));
//
//		InputStream ticketReportStream = null;
//
//		try {
//			ticketReportStream = JReportPrintService.class.getResourceAsStream("/com/pinpos/report/KitchenReceipt.jasper");
...
//			printColumnSeparator(posPrinter);
//			printColumn(posPrinter, com.pinpos.POSConstants.QTY, 6);
//			printColumnSeparator(posPrinter);
...
//		}
	...
	public static void printServerTipsReport(TipsCashoutReport report) {
		...
		try {
			...
			parameters.put("transactionCount", report.getDatas() == null ? "0" : String.valueOf(report.getDatas().size()));
			...
			JasperReport mainReport = (JasperReport) JRLoader.loadObject(JReportPrintService.class.getResourceAsStream("/com/pinpos/report/ServerTipsReport.jasper"));
