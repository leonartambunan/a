...
import com.pinpos.ui.forms.UserTypeForm;
...
public class UserTypeExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog.showMessage(UserTypeExplorer.this, com.pinpos.POSConstants.CONFIRM_DELETE, com.pinpos.POSConstants.DELETE) == ConfirmDeleteDialog.YES) {
	...
	class UserTypeExplorerTableModel extends AbstractTableModel {
		String[] columnNames = {com.pinpos.POSConstants.TYPE_NAME, com.pinpos.POSConstants.PERMISSIONS};
