...
import com.pinpos.bo.ui.explorer.UserTypeExplorer;

public class UserTypeExplorerAction extends AbstractAction {

	public UserTypeExplorerAction() {
		super(com.pinpos.POSConstants.USER_TYPES);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(com.pinpos.POSConstants.USER_TYPE_EXPLORER);
		if (index == -1) {
			explorer = new UserTypeExplorer();
			tabbedPane.addTab(com.pinpos.POSConstants.USER_TYPE_EXPLORER, explorer);
		}
		else {
