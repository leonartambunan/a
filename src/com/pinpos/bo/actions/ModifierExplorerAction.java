...
import com.pinpos.bo.ui.explorer.ModifierExplorer;

public class ModifierExplorerAction extends AbstractAction {

	public ModifierExplorerAction() {
		super(com.pinpos.POSConstants.MENU_MODIFIERS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(com.pinpos.POSConstants.MODIFIER_EXPLORER);
		if (index == -1) {
			modifier = new ModifierExplorer();
			tabbedPane.addTab(com.pinpos.POSConstants.MODIFIER_EXPLORER, modifier);
		}
		else {
