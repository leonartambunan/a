...
public class KitchenTerminal extends JPanel {
	...
	public KitchenTerminal() {
		...
		kitchenTicketView_1.setTicket(createTicket(new String[] {"Hot Cake", "Small Burger", "Small coke"}, new int[]{5, 5, 5}, new double[] {5, 7, 2}));
	...
	public static void main(String[] args) {
		...
		frame.setTitle(POSConstants.MDS_POS + " - Kitchen Terminal");
