...
import com.pinpos.model.CreditCardTransaction;
import com.pinpos.model.DebitCardTransaction;
...
public class SalesDetailedReport {
	...
	public class DrawerPullDataTableModel extends ListTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch (columnIndex) {
				case 0:
					return com.pinpos.POSConstants.DRAWER_PULL_ + data.drawerPullId;
