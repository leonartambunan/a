...
//	private POSTextField tfDefaultGratuity;
	...
	public RestaurantConfigurationView() {
		...
		JLabel lblNewLabel = new JLabel(POSConstants.RESTAURANT_NAME + ":");
...
//		add(label_1, "cell 2 13");
		...
		JLabel lblTicketFooterMessage = new JLabel(Messages.getString("TicketFooterMsg") + ":");
		add(lblTicketFooterMessage, "cell 0 14,alignx trailing");

//		JLabel lblInitialCashMessage = new JLabel( Messages.getString("InitCash")+ ":");
//		add(lblInitialCashMessage, "cell 0 15,alignx trailing");
	...
	public boolean save() throws Exception {
		...
		if(StringUtils.isEmpty(currencyName)) {
			currencyName = com.pinpos.POSConstants.DOLLAR;
		}
		...
		try {
			...
			POSMessageDialog.showError(this, com.pinpos.POSConstants.CAPACITY_IS_NOT_VALID_);
			return false;
		}
		...
		try {
			...
			POSMessageDialog.showError(this, com.pinpos.POSConstants.NUMBER_OF_TABLES_IS_NOT_VALID);
			return false;
		}
...
//		restaurant.setInitialCash(Double.parseDouble(tfInitialCash.getText()));
...
//		tfDefaultGratuity.setText(String.valueOf(restaurant.getDefaultGratuityPercentage()));
	...
	public String getName() {
		return com.pinpos.POSConstants.CONFIG_TAB_RESTAURANT;
	}
}
